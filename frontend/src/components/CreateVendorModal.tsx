...
import { createVendor, CreateVendorInput } from '../api/vendor';
...
export const CreateVendorModal: React.FC<CreateVendorModalProps> = ({ onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const submitData: CreateVendorInput = {
        ...formData,
          ...
          <form onSubmit={handleSubmit}>
            <div className="bg-white px-6 pt-6 pb-4 max-h-[80vh] overflow-y-auto">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-bold text-secondary-900">Add New Vendor</h3>
                <button
                  type="button"
                  onClick={onClose}
